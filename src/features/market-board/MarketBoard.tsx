export function MarketBoard() {
  return (
    <div className="board">
      ...
      <div className="method-note"><span>ⓘ</span><p><strong>Honest empty state.</strong> Demonstration markets, prices, probabilities, balances and tips have been removed.</p></div>
    </div>
  );
}
